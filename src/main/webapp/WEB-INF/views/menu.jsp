        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/Practica_SpringMVC-1.0-SNAPSHOT/editoriales/create">Registrar editorial</a></li>
                        <li><a href="/Practica_SpringMVC-1.0-SNAPSHOT/editoriales/list">Ver lista de editoriales</a></li>
                    </ul>
                </li>
            </ul>
...
<li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="?locale=es">Español</a></li>i>
                <li><a href="?locale=en">Ingles</a></li>i>
            </ul>
        </li>
        </ul>
